        ...
        <div className="relative max-w-xl mx-auto text-center">
          ...
          <div className="relative bg-[#12121a]/90 border border-gray-800/50 backdrop-blur-2xl rounded-2xl p-12">
            ...
            <div className="relative">
              <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-lime-500/10 to-blue-500/10 mb-6 ring-1 ring-gray-800/60">
                <Zap className="w-8 h-8 text-[#DDFF00]" />
              </div>

              <h1 className="text-3xl font-semibold text-white mb-3">Lifetime Pro Plan Active</h1>
              <p className="text-gray-400 mb-8 text-lg">
                Experience the full power of Snapzion and unlock limitless image creation.
              </p>
              ...
              >
                ...
                <span>Start Generating Images</span>
